...
const BLOCKS = [
  ...
  // Native Obsidian callout types. Core renders these consistently, so the
  // colors and icons adapt to whatever theme is active.
  {
    title: "Note callout",
    desc: "Callout for a general note",
    icon: "pencil",
    keywords: ["note", "callout", "admonition", "remark"],
    template: "> [!note] " + CARET + "\n> ",
  },
  {
    title: "Info callout",
    desc: "Callout for informational context",
    icon: "info",
  ...
  },
  {
    ...
    desc: "Callout to flag a caution",
    icon: "alert-triangle",
    keywords: ["warning", "caution", "warn", "callout", "admonition"],
    template: "> [!warning] " + CARET + "\n> ",
  },
  {
    title: "Code block",
    desc: "Fenced code",
